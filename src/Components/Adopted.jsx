                    ...
                    <Row className=' align-items-center flex-lg-row flex-column-reverse'>
                        <Col lg={8} xs={12}>
                            <Row className='p-0 pt-lg-0 pb-5'>
                                <Col lg={4} sm={6} className='ps-sm-5 align-items-sm-start align-items-center adopt_line d-flex flex-column justify-content-center' data-aos="fade-up"
                                ...
                                <Col lg={4} sm={6} className='d-flex align-items-sm-start align-items-center pt-3 pt-sm-0 adopt_line_2 ps-sm-5 flex-column justify-content-center' data-aos="fade-up"
                                    data-aos-duration="3000">
                                ...
                                <Col lg={4} sm={6} className='ps-sm-5 align-items-center align-items-sm-start py-3 py-lg-0 d-flex  flex-column justify-content-center' data-aos="fade-up"
                                    data-aos-duration="3000">
                        ...
                        <Col lg={4} xs={12} className='p-0 d-flex align-items-center' data-aos="fade-down"
                            data-aos-duration="3000">
